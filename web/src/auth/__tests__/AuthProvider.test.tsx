...
describe('AuthProvider', () => {
  ...
  it('stores access token in authStore after successful sign-in', async () => {
    ...
    mockFetch.mockResolvedValueOnce(makeResponse({ access_token: jwt, refresh_token: null, user: validUser }));
  ...
  it('does not schedule a refresh timer when the token is already within the 60-second window', async () => {
    ...
    mockFetch.mockResolvedValueOnce(makeResponse({ access_token: nearlyExpiredJwt, refresh_token: null }));
