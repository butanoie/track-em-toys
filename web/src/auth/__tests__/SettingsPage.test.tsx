...
vi.mock('@react-oauth/google', () => ({
  GoogleLogin: ({ onSuccess, onError }: { onSuccess: (r: { credential: string }) => void; onError: () => void }) => (
    <div>
      <button onClick={() => onSuccess({ credential: 'google-token' })}>Continue with Google</button>
...
describe('SettingsPage', () => {
  ...
  it('shows linked accounts with badges', () => {
    vi.mocked(useMe).mockReturnValue({
      data: {
        ...mockUser,
        linked_accounts: [{ provider: 'google' as const, email: 'test@gmail.com' }],
      },
      isPending: false,
      isError: false,
      isSuccess: true,
  ...
  it('links Google account on Google button click', async () => {
    ...
    vi.mocked(useMe).mockReturnValue({
      data: {
        ...mockUser,
        linked_accounts: [{ provider: 'apple' as const, email: 'apple@example.com' }],
      },
      isPending: false,
      isError: false,
      isSuccess: true,
