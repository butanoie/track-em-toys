...
const characterDepictionDetailItem = {
  ...
  properties: {
    ...
    appearance_name: { type: 'string' },
    appearance_source_media: { type: ['string', 'null'] },
    appearance_source_name: { type: ['string', 'null'] },
...
const itemDetail = {
  ...
  properties: {
    ...
    characters: { type: 'array', items: characterDepictionDetailItem },
