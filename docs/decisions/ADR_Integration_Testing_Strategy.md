...
> **Note:** Gherkin syntax is still used as a _specification language_ in `docs/test-scenarios/` markdown files. This provides the documentation benefit of BDD without the tooling overhead. See `docs/guides/TESTING_SCENARIOS.md`.
